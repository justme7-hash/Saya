...
async def cancel_search_message(message: Message, state: FSMContext) -> None:
    """لغو جستجو از دکمه‌ی ریپلای کیبورد."""
    await _do_cancel_search(message, message.from_user.id, state)
