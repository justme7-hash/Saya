...
if TYPE_CHECKING:
    ...
    from anonchat.services.anonymous_message_service import AnonymousMessageService
...
class Container:
    ...
    @property
    def anon_message_service(self) -> AnonymousMessageService:
        from anonchat.services.anonymous_message_service import AnonymousMessageService
        if not hasattr(self, "_anon_service"):
            self._anon_service = AnonymousMessageService(self)  # type: ignore[attr-defined]
        return self._anon_service  # type: ignore[attr-defined]
