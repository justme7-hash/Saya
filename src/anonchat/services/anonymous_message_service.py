...
class AnonymousMessageService:
    ...
    def _get_bot_username(self) -> str:
        """دریافت username ربات از تنظیمات یا پیش‌فرض."""
        # در نسخه کامل، می‌توان این را از Bot API گرفت
        # فعلاً از یک مقدار پیش‌فرض استفاده می‌کنیم
        return "saya_anon_bot"
    ...
    async def _send_to_recipient(
        ...
        if msg_type == "text":
            ...
            return await bot.send_video_note(recipient_id, video_note=file_id, reply_markup=keyboard)
