    ...
    async def update_profile(
        ...
        async with self._container.session() as session:
            ...
            if "interests" in fields:
                fields["interests"] = (
                    ",".join(fields["interests"]) if fields["interests"] else None
                )
